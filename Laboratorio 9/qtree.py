import random
import matplotlib.pyplot as ptl #Biblioteca para graficar
...
def subdivison_recursiva(nodo:Nodo, k:int):
    ...
    p = cuantas_contiene(nodo.x0, nodo.y0, w_, h_, nodo.partculas)
    nodo.x1 = Nodo(nodo.x0, nodo.y0, w_, h_, p)
    subivisiones_recursiva(nodo.x1, k)
